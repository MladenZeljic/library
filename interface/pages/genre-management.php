...
<html>
	...
	<div class="page-body-wrap">
		<div class="page-body">
			<div class="body-nav">
			<ul id="tabs">
				<li id="tab-1" onclick="show_selected_view(this);" class="available-tab <?php $helper->print_active_tab_class() ?>"><a href="javascript:void(0);">Add genre</a></li>
				<li id="tab-2" onclick="show_selected_view(this);" class="available-tab <?php $helper->print_active_tab_class(true) ?>"><a href="javascript:void(0);">Available genres</a></li>
			<ul>
			</div>
			<div id="views">
				...
				<div id="tab2-view" class="<?php $helper->print_hide_view_class(true); ?>" >
					...
					<div class="table-container">
						...
						while($i <= $pages_count){
							...
							echo " href=genre-management.php";
							if(!isset($_GET["search"])){ 
								echo "?page=".$i;
							} 
							else{ 
